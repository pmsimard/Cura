...
setting('sdcard_autosortcontent', 'False', bool, 'preference', 'hidden').setLabel(_("Auto sort content after save"), _("The LED display on the UM does not sort folders and files. When this is checked, files and folders on the SD card will be sorted (by name, folder first, files last) by moving back and forth content in temp folders. This move the data on the FAT of the card."))
